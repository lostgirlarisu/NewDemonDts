...
namespace sys
{
	...
	$gwin = Array(0 => '程序故障', 1 => '全部死亡',2 => '最后幸存',3 => '锁定解除',4 => '无人参加',5 => '核爆全灭',6 => 'GM中止',7=>'幻境解离',11=>'L.O.O.P');
	...
	$dinfo = Array(
		...
		100 => '你伸手想阻挡刺眼的光芒，但你的意识就好像被那光芒吞噬了似的……<br><span class="clan">“这新的一页很棒喔。”</span><br>你最后只听到了少女的这么一句话。',
	);
